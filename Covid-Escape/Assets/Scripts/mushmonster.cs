...
public class mushmonster : MonoBehaviour
{
    public Sprite[] anim;
    public Sprite[] animdead;
    public Sprite[] animtakehit;
    public Sprite[] animattack;
    public LayerMask playermask;
    int animtimer = 0;
    int animtimerdead = 0;
    int animtimerhit = 0;
    int animtimerattack = 0;
    public int health;
    float timer = 0;
    float attacktimer = 0;
    ...
    Vector3 vec;
    Vector3 vecsave = new Vector3(-1.6f, 0, 0);
    Vector3 vecscale = new Vector3(1.35f, 1.35f, 1.35f);
    Transform monster;
    GameObject player;
    RaycastHit2D hit;
    Animator animtor;
    ...
    void Update()
    {
        ...
        //if (animtimerattack == 6) {
        //    player.GetComponent<charactermov>().underattack = true; transform.GetChild(0).gameObject.SetActive(true); 
        //}
        //else { player.GetComponent<charactermov>().underattack = false; transform.GetChild(0).gameObject.SetActive(false); 
        //}

        //if (health <= 0) { onetimework = true; }
    }
    ...
    public void attack()
    { player.GetComponent<charactermov>().underattack = true; }
